...
CompositePattern.Directory RootDirectory = new CompositePattern.Directory("RootDirectory");

//Add 2 More Folders i.e. two more composite objects  
CompositePattern.Directory Folder1 = new CompositePattern.Directory("Folder1");
CompositePattern.Directory Folder2 = new CompositePattern.Directory("Folder2");
...
CompositePattern.Directory SubFolder1 = new CompositePattern.Directory("Sub Folder1");
